...
class IncomeCats extends StatefulWidget {
  const IncomeCats({Key? key}) : super(key: key);

  @override
  State<IncomeCats> createState() => _IncomeCatsState();
}

class _IncomeCatsState extends State<IncomeCats> {
  int isCatSelected = -1;
              ...
              () {
                ...
                return GridView.builder(
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      mainAxisSpacing: 10,
                      crossAxisSpacing: 50),
                  itemCount: CategoryDatabase.instance.incomeCatsList.length,
                  itemBuilder: (BuildContext context, int index) {
                    final data =
                        CategoryDatabase.instance.incomeCatsList[index];
                    ...
                    return ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary: isCatSelected == index
                              ? Colors.black
                              : const Color.fromARGB(255, 90, 218, 95),
                        ),
                        onPressed: () {
                          setState(() {
                            isCatSelected = index;
                          ...
                          TransactionDatabase.instance
                              .sortForSelectedCat(selectedCatName, 0);
                        },
                        child: Text(catName));
                  },
                );
            ...
            child: Container(
                ...
                child: Obx(() {
                  ...
                  return (TransactionDatabase
                              .instance.selectedCatTrans.isEmpty ||
                          TransactionDatabase
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            final data = isbuttonPressed == false
                                ? TransactionDatabase
                                    .instance.incomeTransactionList[index]
                                : TransactionDatabase
