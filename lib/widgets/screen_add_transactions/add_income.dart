...
class AddIcome extends StatefulWidget {
  const AddIcome({Key? key}) : super(key: key);

  @override
  State<AddIcome> createState() => _AddIcomeState();
}

class _AddIcomeState extends State<AddIcome> {
                      ...
                      children: [
                        ...
                        Flexible(child: Obx(() {
                          ...
                          return DropdownButton(
                              ...
                              items: CategoryDatabase.instance.incomeCatsList
                                  .map((e) {
