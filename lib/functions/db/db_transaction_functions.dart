...
class TransactionDatabase {
  ...
  Map<String, double> expallMap = <String, double>{}.obs;
  ...
  TransactionDatabase.internal();
  static TransactionDatabase instance = TransactionDatabase.internal();
  ...
  piedata() async {
    final _db = await Hive.openBox<TransactionModel>("TransactionDB2");
    ...
    totalBalaceCalculation(allTransactionList);
  }
